...
A questão, portanto, não é alterar os conteúdos disciplinares, mas, sim, a maneira como eles devem ser trabalhados \citep{valente_tecnologia_2018}.
 ...
 %Apesar de não ser diretamente aplicada na proposta de tese, o conceito da Sala de Aula Invertida foi explorado, tanto no acompanhamento de aulas de matemática no Instituto Superior Técnico, através de uma plataforma de ensino à distância da universidade, o MOOC Técnico, como também para analisar a motivação de estudantes durante os estudos de matemática, através de um protocolo que analisa os níveis de motivação, chamado-se COPUS \citep{smith_classroom_2013}.
